...
# install.packages("elevatr", repos = "http://cran.us.r-project.org")
...
# install.packages("grImport", repos = "http://cran.us.r-project.org")
# install.packages("ggplot2", repos = "http://cran.us.r-project.org")
# install.packages("httr", repos = "http://cran.us.r-project.org")
# install.packages("jsonlite", repos = "http://cran.us.r-project.org")
# install.packages("textreadr", repos = "http://cran.us.r-project.org")
# install.packages("rgdal", repos = "http://cran.us.r-project.org")
# install.packages("geotech", repos = "http://cran.us.r-project.org")
...
lat2<- 34.50250 #length, y
long2<- -119.80720 #width, x
...
s1 <- as.data.frame(e1$e1+((g1$g1-a1$a1)*(tan(r1$r1)))+((n1$n1-a1$a1)*((q1$q1-p1$p1)/(o1$o1-p1$p1))*(tan(r1$r1)))) #Shear Strength, Resisting Force (kPa)
s1$s1 <- s1[["e1$e1 + ((g1$g1 - a1$a1) * (tan(r1$r1))) + ((n1$n1 - a1$a1) * ((q1$q1 - p1$p1)/(o1$o1 - p1$p1)) * (tan(r1$r1)))"]]
s1[["e1$e1 + ((g1$g1 - a1$a1) * (tan(r1$r1))) + ((n1$n1 - a1$a1) * ((q1$q1 - p1$p1)/(o1$o1 - p1$p1)) * (tan(r1$r1)))"]] <- NULL
...
s2 <- as.data.frame(e2$e2+((g2$g2-a2$a2)*(tan(r2$r2)))+((n2$n2-a2$a2)*((q2$q2-p2$p2)/(o2$o2-p2$p2))*(tan(r2$r2)))) #Shear Strength, Resisting Force (kPa)
s2$s2 <- s2[["e2$e2 + ((g2$g2 - a2$a2) * (tan(r2$r2))) + ((n2$n2 - a2$a2) * ((q2$q2 - p2$p2)/(o2$o2 - p2$p2)) * (tan(r2$r2)))"]]
s2[["e2$e2 + ((g2$g2 - a2$a2) * (tan(r2$r2))) + ((n2$n2 - a2$a2) * ((q2$q2 - p2$p2)/(o2$o2 - p2$p2)) * (tan(r2$r2)))"]] <- NULL
